...
/**
 * Temporary pre-CNL snapshot for the Mission Telemetry migration test. It preserves the former YAML-authored Telemetry source: a 3-column grid frame with a
 ...
 */
internal val MissionTelemetryYamlSnapshot: String = missionSlm(
    """
    ---
