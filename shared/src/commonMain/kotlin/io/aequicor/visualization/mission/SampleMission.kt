...
const val SampleMissionMarkdown: String = """
# Mission onboarding flow

This document is the demo source for mission-visualization. Agents can edit the
strict spec block below and keep the surrounding Markdown as human-readable context.
