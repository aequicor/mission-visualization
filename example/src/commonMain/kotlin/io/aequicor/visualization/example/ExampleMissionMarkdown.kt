...
const val ExampleMissionMarkdown: String = """
# Пример: сценарий контроля миссии

Этот файл показывает, как внешний проект может описать экраны, сценарии,
замечания и дальнейшие prompt-правки без подключения Figma.
