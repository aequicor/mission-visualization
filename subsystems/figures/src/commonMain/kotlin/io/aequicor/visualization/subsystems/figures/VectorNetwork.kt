 ...
 * loops fill. Lives in the SAME coordinate space as the enclosing the enclosing Shape node's
...
data class VectorVertex(
    ...
    /**
     * Corner rounding radius applied when this vertex joins two straight segments (Figma's
     * per-vertex corner radius). 0 = sharp. Clamped to half the shorter adjacent segment.
     */
