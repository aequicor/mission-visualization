...
private fun DiagramEdgeDto.toModel(): DiagramEdge = DiagramEdge(
    ...
    lineJumps = parseEnumOr(lineJumps, LineJumpStyle.NONE),
...
private fun DiagramStyleDto.toModel(): DiagramStyle = DiagramStyle(
    ...
    opacity = opacity,
    cornerStyle = parseEnumOr(cornerStyle, DiagramCornerStyle.SHARP),
    sketch = sketch,
    shadow = shadow,
)
